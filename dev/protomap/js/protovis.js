...
pv.Mark.prototype.build = function() {
  ...
  //console.log("data - "); //console.log(data.value.apply);
  //var whutwhut = data.value.apply(this, stack); console.log(whutwhut);
  //if(whutwhut == undefined){ whutwhut = []; } console.log(whutwhut);
